...
namespace AnimationLibrary
{
    ...
    public class SolidColor : Animation
    {
        ...
        public SolidColor(Color color, byte brightness)
        {
            FrameCount = 1;
            LedCount = 150;
            FrameRate = 1;
            ...
            SelectedColor.Blue = (byte)(SelectedColor.Blue * brightness / 255);
            SelectedColor.Green = (byte)(SelectedColor.Green * brightness / 255);
            SelectedColor.Red = (byte)(SelectedColor.Red * brightness / 255);
