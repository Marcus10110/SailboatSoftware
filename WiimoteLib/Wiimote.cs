...
namespace WiimoteLib
{
    ...
    public class Wiimote : IDisposable
    {
        ...
        public event EventHandler<EventArgs> WiimoteDisconnected;
        ...
        public static bool WiiMoteDetected()
        {
            int index = 0;
            bool found = false;
            Guid guid;
        ...
        private void OnReadData( IAsyncResult ar )
        {
            ...
            try
            {
                ...
                {
                    //probably disconnected. time to reconnect.
                    WiimoteDisconnected( this, null );
                    return;
                }
        ...
        private bool ParseInputReport( byte[] buff )
        {
            ...
            switch( type )
            {
                ...
                case InputReport.OutputReportAck:
                    ...
                    if( buff[ 4 ] == 0x03 )
                        Debug.WriteLine( "error detected." );//throw new Exception( "wiimote returned an error in a Report Ack" );
                    mWriteDone.Set();
                    break;
                default:
